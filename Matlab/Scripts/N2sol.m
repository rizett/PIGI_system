function [conc_N2,deriv,derivS] = N2sol(S,T)
...
% Calculate derivative
    deriv = conc_N2 .* (A1_n2.*dT(T,1) + A2_n2.*dT(T,2) + A3_n2.*dT(T,3) + S.*(B1_n2.*dT(T,1) + B2_n2.*dT(T,2)));
    
    derivS = conc_N2 .* (B0_n2 + B1_n2*temp_S + B2_n2*temp_S.^2);
