...
;Message box - warn that the acquisition will be restarting soon
   MsgBox ($MB_ICONWARNING, " ", "Underway Acquisition restarting in 10 seconds. Do not touch mouse.", 10)

;Wait briefly
   Sleep (500)

;Activate LV window that runs the main acquisition
   Local $hWnd = "autoPIGI_underway_2020"
   WinSetState($hWnd,"", @SW_SHOW)
   Sleep (1000)
   WinActivate("autoPIGI_underway_2020")
   Sleep (1000)
